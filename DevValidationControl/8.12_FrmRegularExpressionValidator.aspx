<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="8.12_FrmRegularExpressionValidator.aspx.cs" Inherits="DevValidationControl._8__12_FrmRegularExpressionValidator" %>
...
<body>
  ...
  <asp:Re`ularExpressionValidator ID="valEmail" runat="server"
      ErrorMessage="이메일을 정확히 입력하시오."
      ControlToValidate="txtEmail"
      ValidationExpression="\w+([-+.‘]\w+)@\w+([-.]\w+).\w+([-.]\w+)"
      ></asp:Re`ularExpressionValidator>
  <br />
  홈페이지:
